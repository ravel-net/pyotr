...
# sql = "select t0.n1, t2.n2 from t_prime t0, t_prime t1, t_prime t2, t_prime t3, t_prime t4 where t0.n1 = '1' and t0.n2 = t1.n1 and t2.n2 = '2' and t1.n2 = t2.n1 and t3.n1 = t3.n2 and t1.n1 = t3.n2 and t4.n1 = t4.n2 and t2.n1 = t4.n2"
# sql = "select 1, 2 from t_prime t0, t_prime t1, t_prime t2, t_prime t3, t_prime t4, t_prime t5 where t0.n1 = '1' and t0.n2 = t1.n1 and t2.n2 = '2' and t1.n2 = t2.n1 and t3.n1 = '1' and t3.n2 = '1' and t4.n1 = t4.n2 and t1.n1 = t4.n2 and t5.n1 = t5.n2 and t2.n1 = t5.n2"
