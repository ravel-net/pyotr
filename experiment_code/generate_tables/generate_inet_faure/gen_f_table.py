...
def gen_f_table(tablename = 'rib1000'):
    ...
    cur.execute("CREATE TABLE f_table_{}(id SERIAL PRIMARY KEY, fid inet_faure, nid1 TEXT, nid2 TEXT, condition TEXT[], mark SMALLINT)".format(tablename))
...
if __name__ == '__main__':
    ...
    for size in sizes:
        ...
        # create_index_fid_mark(tablename='f_table_'+tablename) TODO: Make inet_faure index-ible
