...
if __name__ == '__main__':
    size = 6 # the number of nodes in physical network path
    rate = 0.7 # the percentage of constant nodes in physical network path (the number of nodes in overlay path)
    ...
    sql = tableau.convert_tableau_to_sql(physical_tuples+phy_self_tuples, "T_v", overlay_nodes)
    overlay_nodes = ['1', '2']
    custom_nodes = [('1','u','{}'), ('u', 'v','{}'), ('v', '2','{}'), ('1', '1','{}'), ('u','u','{}'), ('v','v','{}')]
    sql = tableau.convert_tableau_to_sql(custom_nodes, "test2", overlay_nodes)
    print(sql)
    pp = pprint.PrettyPrinter(indent=4)
    print("\n================Tableau==================")
    pp.pprint(custom_nodes)
