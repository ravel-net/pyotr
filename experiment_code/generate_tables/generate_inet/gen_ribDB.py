...
def gen_raw_rib_table(filename='rib0610.txt', table_name='rib0610'):
    ...
    cur.execute("CREATE TABLE {}(Prefix inet, AS_PATH TEXT, Next_Hop inet, Local_Pref TEXT, MED TEXT)".format(table_name))
...
def gen_subset_rib(table_name='rib0610', size = 1000):
    ...
    cur.execute("CREATE TABLE rib{}(Prefix inet, AS_PATH TEXT, Next_Hop inet, Local_Pref TEXT, MED TEXT)".format(size))
    ...
    # cur.execute(index_sql) TODO: Make inet index-ible
