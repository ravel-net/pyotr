...
# cd ./experiment_code/generate_tables/generate_inet
python3 gen_ribDB.py 100 1000
python3 gen_f_table.py 100 1000
python3 gen_r_table.py 100 1000
cd ../
python3 test_sql_generator.py "test1.sql" "inet_postgres_join_1000.txt" 20 "select f_table_rib1000.nid1, f_table_rib1000.nid2 from f_table_rib1000, rib1000 where (f_table_rib1000.fid & '255.255.0.0/16') = (rib1000.prefix & '255.255.0.0/16');"
