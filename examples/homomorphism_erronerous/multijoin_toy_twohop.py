...
from variable_closure_algo.closure_overhead import find_variables, construct_Graph, calculate_tableau
...
cursor.execute("drop table if exists T_th")
cursor.execute("create table T_th (n1 int4_faure, n2 int4_faure, condition text[])")
cursor.executemany("insert into T_th values(%s, %s, %s)", physical)
conn.commit()

# group: 0 length: 7 [('1', 'x1'), ('x1', 'x2'), ('x2', 'x3'), ('x3', '22'), ('x1', 'x1'), ('x2', 'x2'), ('x3', 'x3')]
# remove ('x9', 'x9')
# group = [('1', 'x1'), ('x1', 'x2'), ('x2', 'x3'), ('x3', '22'), ('x1', 'x1'), ('x2', 'x2'), ('x3', 'x3')]
...
cursor.execute("drop table if exists T_prime_th")
cursor.execute("create table T_prime_th (n1 int4_faure, n2 int4_faure, condition text[])")
cursor.executemany("insert into T_prime_th values(%s, %s, %s)", t_prime)
conn.commit()

sql = tableau.convert_tableau_to_sql(group, "t_prime_th", overlay_nodes)
...
row = "data_time condition_time z3_time total_time \n"
