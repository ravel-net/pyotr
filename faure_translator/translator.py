...
if __name__ == "__main__":
    ...
    # sql = gen_sql_p_to_v("t_2", "t_2_o", [])
    sql = "select t0.n1, t2.n2 from tp_t t0, tp_t t1, tp_t t2, tp_t t3, tp_t t4, tp_t t5 where t0.n1 = '1' and t0.n2 = t1.n1 and t2.n2 = '2' and t1.n2 = t2.n1 and t3.n1 = '1' and t3.n2 = '1' and t4.n1 = t4.n2 and t1.n1 = t4.n2 and t5.n1 = t5.n2 and t2.n1 = t5.n2"
