...
def BDD_example1():
    ...
    i_1       i_1        R1      R3                                     ['And(i_1 == #1xxxxx, i_1 != #10x01x)']
    i_1       i_1        R2      B                                      ['i_1 == #10xxxx']
    i_1       i_1        R3      D                                      ['i_1 == #xxx1xx']
    i_1       i_1        R3      R2          ['i_1 == #x0xxxx']         ['And(i_1 == #1xxxxx, i_1 != #xxx1xx)']
    '''
    sql = "insert into F_nod values ('-16','-16', 10, 20, '{}','{\"i_1 == #10x01x\"}'),('-16','-16', 10, 30, '{}','{\"And(i_1 != #10x01x, i_1 == #1xxxxx)\"}'),('-16','-16', 20, 123, '{}','{\"i_1 == #10xxxx\"}'),('-16','-16', 30, 245, '{}','{\"i_1 == #xxx1xx\"}'),('-16','-16', 30, 20, '{\"i_1 == #x0xxxx\"}','{\"And(i_1 != #xxx1xx, i_1 == #1xxxxx\"}')"
