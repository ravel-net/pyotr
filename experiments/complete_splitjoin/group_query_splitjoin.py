...
f = open("./chain50_complete_split.txt", "a")
...
r15_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r15")
r15_end = time.time()
...
r12_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r12")
r12_end = time.time()
...
r16_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r16")
r16_end = time.time()
...
r13_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r13")
r13_end = time.time()
...
r17_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r17")
r17_end = time.time()
...
r14_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r14")
r14_end = time.time()
