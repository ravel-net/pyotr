...
import time 
import json
import translator_naive as translator
import util.tableau.tableau as tableau
import util.merge_tuples.merge_tuples as merge_tuples
...
f = open("./chain{}_complete_split.txt".format(size), "a")
...
r12_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r1_2")
r12_end = time.time()
...
print("R1_3(1, x2) <- R1_2(1, x1), R3(x1, x2)")
...
r13_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r1_3")
r13_end = time.time()
...
print("R14(1, x2) <- R13(1, x2), R4(x2, x2)")
...
r14_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r1_4")
r14_end = time.time()
...
print("R15(1, x3) <- R14(1, x2), R5(x2, x3)")
...
r15_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r1_5")
r15_end = time.time()
...
print("R16(1, x3) <- R15(1, x3), R6(x3, x3)")
...
r16_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r1_6")
r16_end = time.time()
...
print("R17(1, 5) <- R16(1, x3), R7(x3, 5)")
sql = "select 1, 5 from r1_6 t1, T_prime t2 where t1.n2 = t2.n1 and t2.n2 = '5'"
print("R17: ", sql)
f.write("R17 sql: {}\n".format(sql))
...
r17_begin = time.time()
rows = merge_tuples.merge_tuples("output", "r1_7")
r17_end = time.time()
...
# print("R18(1, x4) <- R17(1, x4), R8(x4, x4)")
...
# r18_begin = time.time()
# rows = merge_tuples.merge_tuples("output", "r1_8")
# r18_end = time.time()
...
# print("R19(1, x5) <- R18(1, x4), R9(x4, x5)")
...
# r19_begin = time.time()
# rows = merge_tuples.merge_tuples("output", "r1_9")
# r19_end = time.time()
...
# print("R110(1, x5) <- R19(1, x5), R10(x5, x5)")
...
# rows = merge_tuples.merge_tuples("output", "r1_10")
# r110_end = time.time()
...
# # R111(1, x6) <- R110(1, x5), R11(x5, 5)
# print("R111(1, x6) <- R110(1, x5), R11(x5, 5)")
# sql = "select 1, t2.n2 as n2 from r1_10 t1, T_prime t2 where t1.n2 = t2.n1 and t2.n2 = '5'"
# print("R111: ", sql)
# f.write("R111 sql: {}\n".format(sql))
...
# rows = merge_tuples.merge_tuples("output", "r1_11")
# r111_end = time.time()
