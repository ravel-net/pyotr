...
set output "cdf_chase_distributed_invariants.pdf"

plot 'cdf_static.dat' using ($2/1000):($1) title 'static' with p linestyle 3,\
    'cdf_random.dat' using ($2/1000):($1) title 'random' with p linestyle 2, \
    'cdf_optimal.dat' using ($2/1000):($1) title 'optimal' with p linestyle 4
