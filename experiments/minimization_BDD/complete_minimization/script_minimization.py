...
import util.minimization.minimization_naive.minimization_multi as minimization_naive
import pyotr_translator_BDD.translator_pyotr_BDD as translator_BDD
