...
def table_contains_answer(tablename, domain, variables):
    ...
    check_tauto_time_list.append({"init":var_end-var_begin, "checking":z3_end-z3_begin})
    ...
    if ans == z3.sat:
        model = solver.model()
        print(model)
        return {"check_tauto":check_tauto_time_list}, False
    else:
        return {"check_tauto":check_tauto_time_list}, True
