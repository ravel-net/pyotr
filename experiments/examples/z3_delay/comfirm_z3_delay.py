...
import util.variable_closure_algo.closure_group as closure_group
...
for size in sizes:
    ...
    closure_group = closure_group.getClosureGroup(tuple_to_remove, tuples)
    print("closure_group: ", closure_group)
    variables = closure_group.find_variables(tuples)

    running_time, output_table = split_merge.split_merge(closure_group, t_prime_tablename, variables, summary_nodes, "int4_faure")
