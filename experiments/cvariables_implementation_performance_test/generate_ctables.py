...
import random
import numpy as np
# from Core.Homomorphism.translator_pyotr import generate_tree, data, upd_condition
from faure_translator.translator import generate_tree, data, upd_condition
...
def selectQueries(table, mode, conditions):
    ...
    if conditionalColumnAdd and mode != "string":
...
if __name__ == '__main__':
    ...
    if (mode == "faure"):
        ...
        store_tables("p3", ["dest", "path", "condition"], ["text", "text", "text[]"], p3_data)
    else:
    ...
    sql1 = "select * from p3 where dest >= '20000' and dest < '30000'"
    print(sql1)

    tree = generate_tree(sql1)
    # print(tree)
    data(tree)
    upd_condition(tree)
