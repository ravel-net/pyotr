...
def EC_example1():
    R_nod = DT_Table(name="R_nod", columns={"pkt_in":"integer_faure", "pkt_out":"integer_faure", "node":"integer_faure", "next_hop":"integer_faure","condition":"text[]"}, cvars={"i1":"pkt_in","i2":"pkt_in","i3":"pkt_in","i4":"pkt_in","i5":"pkt_in", "o1":"pkt_out","o2":"pkt_out","o3":"pkt_out","o4":"pkt_out","o5":"pkt_out"}, domain={"next_hop":[10,20,30,40,111,222],"node":[10,20,30,40,111,222],"pkt_in":(0,63),"pkt_out":(0,63)})

    # V1 = DT_Table(name="V1", columns={"header":"integer_faure","path":"integer_faure[]","condition":"text[]"}, cvars={"p":"path"})

    F_nod = DT_Table(name="F_nod", columns={"pkt_in":"integer_faure", "pkt_out":"integer_faure", "node":"integer_faure", "next_hop":"integer_faure","condition":"text[]"}, cvars={"i1":"pkt_in","i2":"pkt_in","i3":"pkt_in","i4":"pkt_in","i5":"pkt_in", "o1":"pkt_out","o2":"pkt_out","o3":"pkt_out","o4":"pkt_out","o5":"pkt_out"}, domain={"next_hop":[10,20,30,40,111,222],"node":[10,20,30,40,111,222],"pkt_in":(0,63),"pkt_out":(0,63)})

    # database = DT_Database(tables=[F,R], cVarMapping = {"y1":-10,"y2":-20,"y3":-30,"x1":-1,"x2":-2,"x3":-1})
    database = DT_Database(tables=[R_nod,F_nod], cVarMapping = {'-1':"i1",'-2':"i2",'-3':"i3",'-4':"i4",'-5':"i5",'-10':"o1",'-20':"o2",'-30':"o3",'-40':"o4",'-50':"o5"})
